...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-0 shadow-none border-radius-xl fixed-top w-100 bg-gray-200 top-0 start-0 translate-center" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-2 mx-3">
